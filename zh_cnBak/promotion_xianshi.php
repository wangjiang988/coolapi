...
$lang['xianshi_apply_cancel_success'] = '申请取消成功';
$lang['xianshi_apply_cancel_fail'] = '申请取消失败';
$lang['xianshi_apply_verify_success'] = '限时折扣申请审核成功，活动套餐已经发放';
$lang['xianshi_apply_verify_fail'] = '限时折扣申请审核失败，用户金币不足';
$lang['xianshi_apply_verify_success_glog_desc'] = '购买限时折扣活动%s个月，单价%s金币，总共花费%s金币';
$lang['xianshi_apply_verify_success_message'] = '您成功购买限时折扣活动%s个月，单价%s金币，总共花费%s金币，时间从审核后开始计算';
$lang['xianshi_apply_verify_fail_message'] = '您购买限时折扣活动的审核已失败，请检查您的金币余额';
...
$lang['xianshi_apply_list_help1'] = '对卖家的限时折扣活动申请进行审核，审核后系统会使用站内信通知卖家';
$lang['xianshi_apply_list_help2'] = '当卖家金币不足时审核会失败';
...
$lang['xianshi_list_help2'] = '取消操作不可恢复，请慎重操作';
$lang['xianshi_list_help3'] = '点击详细链接查看活动详细信息';
