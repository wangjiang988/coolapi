<?php defined('CoolAPI') or exit('Access Invalid!');?>
      ...
      <tfoot>
        ...
        <tr class="tfoot">
          ...
          <td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
            &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="submit_form('pass');" name="id"><span><?php echo $lang['nc_pass'];?></span></a><a href="JavaScript:void(0);" class="btn" onclick="submit_form('refuse');" name="id"><span><?php echo $lang['nc_refuse'];?></span></a>
