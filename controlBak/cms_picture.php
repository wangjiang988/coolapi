 ...
 *
 *
 * @copyright  Copyright (c) 2007-2012 ShopNC Inc. (###)
 * @license    ###
 * @link       ###
...
class cms_pictureControl extends SystemControl{
    ...
    private function get_cms_picture_list($condition, $menu_key) {
        ...
        Tpl::output('picture_type_list', $this->get_picture_type_list());
     ...
     * 获取类型列表
     */
    private function get_picture_type_list() {
        $array = array();
        $array[self::ARTICLE_TYPE_MEMBER] = Language::get('cms_article_type_member');
        $array[self::ARTICLE_TYPE_ADMIN] = Language::get('cms_article_type_admin');
        return $array;
    }
