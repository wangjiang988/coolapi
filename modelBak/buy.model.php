...
class buyModel {
    ...
    private function _complateOrder($goods_list = array()) {
        ...
        foreach ($goods_list as $goods_info) {
            ...
            $sale_date_array = $model->table('salenum')->where(array('date'=>$date,'goods_id'=>$goods_info['goods_id']))->find();
            if(is_array($sale_date_array) && !empty($sale_date_array)){
                ...
                $model->table('salenum')->insert(array('date'=>$date,'salenum'=>$goods_info['goods_num'],'store_id'=>$goods_info['store_id'],'goods_id'=>$goods_info['goods_id']));
            }            
        }
    }
